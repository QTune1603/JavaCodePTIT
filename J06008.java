...
class giaoVien{
    private String Ma, Ten, tenMonHoc;
    ...
    public static void main(String[] args) {
        ...
        for(giaoVien x : dsGv) {
            if (x.getMa().equals(maGv)) {
                ...
                for (hocPhan y: dsHp) {
                    if (maGv.equals(y.getMaGv())) {
                        for (monHoc z: dsMh) {
                            if (y.getMaMon().equals(z.getMa())) {
                                System.out.print(z.getTen() + " ");
                                break;
                            }
                        }
                        System.out.println(y.getSoGio());
                ...
                System.out.println("Tong: " + String.format("%.2f", x.getSoGio()));
                break;
            }
        }
        sc.close();
